...
var TimeGridEventRenderer = EventRenderer.extend({
    ...
    return '<a class="' + classes.join(' ') + " " +
      ( eventDef.miscProps != null ? eventDef.miscProps.class : "" )
      + '"' +
			(eventDef.url ?
				' href="' + htmlEscape(eventDef.url) + '"' :
				''
        ) +
      (eventDef.miscProps != null ? 'style="' + eventDef.miscProps.style + '"' : "") +
			(skinCss ?
				' style="' + skinCss + '"' :
				''
				) +
			'>' +
				'<div class="fc-content">' +
					...
					(eventDef.title ?
            '<div class="fc-title ' +
              ( eventDef.miscProps != null ? eventDef.miscProps.titleClass : "" ) +
             '">' +
							eventDef.title +
						'</div>' :
						''
