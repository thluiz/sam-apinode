...
describe("Incidents Tests", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("Create Incidents Tests", () => __awaiter(void 0, void 0, void 0, function* () {
        it("should create incident", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should create incident with people", () => __awaiter(void 0, void 0, void 0, function* () {
            const incident = yield IF.create(runner, yield ITR.findOne(1));
            const registering = yield IS.create_people_incidents({
                incident,
                people: [(yield GF.create_person(runner))],
        ...
        it("should create incident in existing ownership", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should create one incident for each participant", () => __awaiter(void 0, void 0, void 0, function* () {
            const incident = yield IF.create(runner, yield ITR.findOne(1));
            const people = [(yield GF.create_person(runner)), (yield GF.create_person(runner))];
            const registering = yield IS.create_people_incidents({
                incident,
        ...
        it("should create incident with new ownership", () => __awaiter(void 0, void 0, void 0, function* () {
            const typeRequiringOwnership = yield ITR.findOne({ require_ownership: true });
            const incident = yield IF.create(runner, typeRequiringOwnership);
            const people = [(yield GF.create_person(runner)), (yield GF.create_person(runner))];
            const registering = yield IS.create_people_incidents({
        ...
        it("should not create incident without title if type require it", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should not create incident without ownership if type require it", () => __awaiter(void 0, void 0, void 0, function* () {
            const typeRequiringOwnership = yield ITR.findOne({ require_ownership: true });
            const incident = yield IF.create(runner, typeRequiringOwnership);
            const registering = yield IS.create_people_incidents({
                incident,
        ...
        it("should not create incident without ownership if type require it and new support has not been sent", () => __awaiter(void 0, void 0, void 0, function* () {
            const typeRequiringOwnership = yield ITR.findOne({ require_ownership: true });
            const incident = yield IF.create(runner, typeRequiringOwnership);
            const registering = yield IS.create_people_incidents({
                incident,
        ...
        it("should not create incident without ownership if type require it and new owner has not been sent", () => __awaiter(void 0, void 0, void 0, function* () {
            const typeRequiringOwnership = yield ITR.findOne({ require_ownership: true });
            const incident = yield IF.create(runner, typeRequiringOwnership);
            const registering = yield IS.create_people_incidents({
                incident,
        ...
        it("should not create incident with new ownership sending as to add to existing ownership", () => __awaiter(void 0, void 0, void 0, function* () {
            const typeRequiringOwnership = yield ITR.findOne({ require_ownership: true });
            const incident = yield IF.create(runner, typeRequiringOwnership);
            const people = [(yield GF.create_person(runner)), (yield GF.create_person(runner))];
            const registering = yield IS.create_people_incidents({
        ...
        it("should not create incident without value if type require it", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("Close Incidents Tests", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should close ownership", () => __awaiter(void 0, void 0, void 0, function* () {
